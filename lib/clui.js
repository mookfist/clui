...
var helpers = {
  ...
  Spinner: function (message, argSpinColor, argMsgColor) {
    var spinnerMessage = message;

    var spinColor = argSpinColor | clc.white;
    var msgColor  = argMsgColor  | clc.blackBright;
    ...
    this.start = function () {
      ...
      function play(arr, interval) {
        ...
        var drawTick = function () {
          ...
          var output = ansi.cursor.horizontalAbsolute(0)
                     + str
                     + msgColor
                     + spinnerMessage
                     + clc.reset;
